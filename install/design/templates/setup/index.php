...
<input type="hidden" name="server_settings[correct_permissions]" value="0">
                ...
                <div class="control-group control-group-last">
                    ...
                    <div class="controls">
                        <div class="label-value">
                            <?php echo Registry::get('config.http_location'); ?>
                            <input type="hidden" name="server_settings[http_host]" value="<?php echo $this->prepareVar($_tpl_vars, 'server_settings.http_host', 'string', Registry::get('config.http_host')); ?>">
            ...
            <div class="requirement">
                ...
                <div id="server_config_advanced_options" class="collapse">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="server_settings[https_host]" value="<?php echo $this->prepareVar($_tpl_vars, 'server_settings.https_host', 'string', Registry::get('config.http_host')); ?>">
                        </div>
                    </div>
                    <div class="control-group control-group-last">
    ...
    <div class="setting-wrap">
        ...
        <div class="settings">
            <div class="requirement">
                ...
                <label class="checkbox">
                    <input type="checkbox" name="cart_settings[feedback_auto]" value="Y">
                    <?php echo $this->t('help_us_improve_cart'); ?>
                    <span class="muted annotate"><?php echo $this->t('help_us_improve_cart_text'); ?></span>
                </label>
            </div>
        </div>
    </div>
    ...
    <?php
    // Disable theme selector, basic theme should be installed always
    ?>
    <?php if (0 && count($_tpl_vars['available_themes']) > 1): ?>
        ...
        <div class="theme-gallery">
            ...
            <?php foreach ($_tpl_vars['available_themes'] as $theme_name => $theme_preview_image): ?>
                ...
                <?php endif;?>
                <div class="item <?php if ($theme_name == 'basic') {echo ' item-checked';} ?>">
                    ...
                    <input type="hidden" name="cart_settings[theme_name]" <?php if ($theme_name != 'basic') {echo 'disabled="disabled"';} ?> value="<?php echo $theme_name; ?>">
                </div>
        ...
        <?php endif; ?>
    <?php else: ?>
        <input type="hidden" name="cart_settings[theme_name]" value="basic">
    <?php endif; ?>
</div>
